...
contract StablePairHookTest is Test, Fixtures {
    ...
    function setUp() public {
        ...
        deployCodeTo("StablePairHook.sol:StablePairHook", constructorArgs, flags);
        hook = StablePairHook(flags);
    ...
    function test_no_fee_reduction() public {
        ...
        // ~= 1e18 * 1.01 * 0.999
        assertEq(int256(swapDelta.amount1()), int256(1008985981638108244));
    }
